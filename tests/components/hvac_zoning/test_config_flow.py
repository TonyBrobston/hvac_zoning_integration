...
def test_map_foo():
    ...
    expected_dict = {
        'Basement West Vent': '800d6dcc0aef4b6a42476de9ff1403ad',
        'Basement Northeast Vent': '0ae78e2e8f74045281a8ed154cd2b06d',
        'Basement Southeast Vent': '16d81f78e8b7917950f984277ba4feff'
    }

    registry_dict = {entry.original_name: entry.id for entry in registry_entries if entry.original_device_class == original_device_class}
